...
extern dal_param_t CUSTOM_DHCP_param[];
...
extern dal_param_t WIFI_CLIENT_param[];
#endif
...
extern dal_param_t TR471_OBUDPST_param[];
#endif
#ifdef ZYXEL_Support_TR369
extern dal_param_t TR369_LOCAL_AGENT_param[];
extern dal_param_t TR369_LOCAL_AGENT_MTP_param[];
extern dal_param_t TR369_LOCAL_AGENT_MTP_MQTT_param[];
extern dal_param_t TR369_LOCAL_AGENT_CONTROLLER_param[];
extern dal_param_t TR369_LOCAL_AGENT_CONTROLLER_MTP_param[];
extern dal_param_t TR369_LOCAL_AGENT_CONTROLLER_MTP_MQTT_param[];
#endif
#ifdef ZYXEL_L2TPV3
...
extern dal_param_t LWM2M_param[];
#endif
...
extern zcfgRet_t zcfgFeDalCustomDHCP(const char *method, struct json_object *Jobj, struct json_object *Jarray, char *replyMsg);
...
#ifdef SUPPORT_APCLIENT
extern zcfgRet_t zcfgFeDalWifiClient(const char *method, struct json_object *Jobj, struct json_object *Jarray, char *replyMsg);
#endif
...
#endif
#ifdef ZYXEL_TR471_UDP_SPEED_TEST
extern zcfgRet_t zcfgFeDalTR471Obudpst(const char *method, struct json_object *Jobj, struct json_object *Jarray, char *replyMsg);
#endif
#ifdef ZYXEL_Support_TR369
extern zcfgRet_t zcfgFeDalTR369LocalAgent(const char *method, struct json_object *Jobj, struct json_object *Jarray, char *replyMsg);
extern zcfgRet_t zcfgFeDalTR369LocalAgentMtp(const char *method, struct json_object *Jobj, struct json_object *Jarray, char *replyMsg);
extern zcfgRet_t zcfgFeDalTR369LocalAgentMtpMqtt(const char *method, struct json_object *Jobj, struct json_object *Jarray, char *replyMsg);
extern zcfgRet_t zcfgFeDalTR369LocalAgentController(const char *method, struct json_object *Jobj, struct json_object *Jarray, char *replyMsg);
extern zcfgRet_t zcfgFeDalTR369LocalAgentControllerMtp(const char *method, struct json_object *Jobj, struct json_object *Jarray, char *replyMsg);
extern zcfgRet_t zcfgFeDalTR369LocalAgentControllerMtpMqtt(const char *method, struct json_object *Jobj, struct json_object *Jarray, char *replyMsg);
#endif
#ifdef ZYXEL_L2TPV3
...
#endif
#ifdef ZYXEL_LWM2M_CLIENT
extern zcfgRet_t zcfgFeDalLWM2M(const char *method, struct json_object *Jobj, struct json_object *Jarray, char *replyMsg);
#endif
...
#endif
#ifdef ZYXEL_TR471_UDP_SPEED_TEST
extern void zcfgFeDalShowTR471Obudpst(struct json_object *Jarray);
#endif
#ifdef ZYXEL_Support_TR369
extern void zcfgFeDalShowTR369LocalAgent(struct json_object *Jarray);
extern void zcfgFeDalShowTR369LocalAgentMtp(struct json_object *Jarray);
extern void zcfgFeDalShowTR369LocalAgentMtpMqtt(struct json_object *Jarray);
extern void zcfgFeDalShowTR369LocalAgentController(struct json_object *Jarray);
extern void zcfgFeDalShowTR369LocalAgentControllerMtp(struct json_object *Jarray);
extern void zcfgFeDalShowTR369LocalAgentControllerMtpMqtt(struct json_object *Jarray);
#endif
#ifdef ZYXEL_L2TPV3
...
#ifdef SUPPORT_APCLIENT
extern void zcfgFeDalShowWifiClient(struct json_object *Jarray);
#endif
...
extern void zcfgFeDalShowCustomDHCP(struct json_object *Jarray);
...
#endif
#ifdef ZYXEL_LWM2M_CLIENT
extern void zcfgFeDalShowLWM2M(struct json_object *Jarray);
#endif
#ifdef ZYXEL_NUTTCP
...
#endif
{"ethctl",			ETH_CTL_param,		zcfgFeDalEthCtl,		zcfgFeDalShowEthCtl,		"get|edit",				"Vlan_Group"}, //ETHCTL command
...
#ifdef ZYXEL_DHCPV4_SERVER_CUSTOM_DHCP_OPT
{"custom_dhcp",		CUSTOM_DHCP_param,	zcfgFeDalCustomDHCP,	zcfgFeDalShowCustomDHCP,	"get|add|edit|delete",	"Home_Networking"},//Home_Networking
#endif
{"vlan_group", 		VLANGRP_param,		zcfgFeDalVlanGroup,		zcfgFeDalShowVlanGroup,		"get|add|edit|delete",	"Vlan_Group"},//Vlan_Group
...
#ifdef SUPPORT_APCLIENT
{"wlan_client",         WIFI_CLIENT_param, 	zcfgFeDalWifiClient,    zcfgFeDalShowWifiClient,        "edit|get",                     "Wireless"},
#endif
...
#ifdef TELIA_CUSTOMIZATION
{"snmp",			SNMP_param, 		zcfgFeDalSNMP,			zcfgFeDalShowSNMP,			"edit|get",				""},
#else
...
#ifdef ZYXEL_MQTT_PUBLISHER
{"mqtt",	DEV_MQTT_NODE_param,	zcfgFeDalMQTTNode,	zcfgFeDalShowMQTTNode,	"get|edit","TR369_LocalAgent"},
//#if 1//Jessie [#220700403] CLI command to publish to a MQTT broker
#ifdef ZYXEL_CLI_PUBLISH_TO_MQTT_BROKER
{"mqtt_client", 	DEV_MQTT_CLIENT_param,	zcfgFeDalMQTT, 	zcfgFeDalShowMQTT,						"get|add|edit|delete|publish", 	"TR369_LocalAgent"},//MQTT Client
#else
{"mqtt_client", 	DEV_MQTT_CLIENT_param,	zcfgFeDalMQTT, 	zcfgFeDalShowMQTT,						"get|add|edit|delete", 	"TR369_LocalAgent"},//MQTT Client
#endif
{"mqtt_client_publish", 	DEV_MQTT_CLIENT_PUBLISH_param,	zcfgFeDalMQTTClientPublish, 	zcfgFeDalShowMQTTClientPublish,						"get|add|edit|delete", 	"TR369_LocalAgent"},//MQTT_Client_Publish
#endif
#ifdef ZYXEL_TR471_UDP_SPEED_TEST
{"tr471_obudpst",						TR471_OBUDPST_param,					zcfgFeDalTR471Obudpst,					zcfgFeDalShowTR471Obudpst,					"get|edit",				"TR471_Obudpst"}, //TR369 Local Agent
#endif
#ifdef ZYXEL_Support_TR369
{"tr369_local_agent",						TR369_LOCAL_AGENT_param,					zcfgFeDalTR369LocalAgent,					zcfgFeDalShowTR369LocalAgent,					"get|edit",				"TR369_LocalAgent"}, //TR369 Local Agent
{"tr369_local_agent_mtp",					TR369_LOCAL_AGENT_MTP_param,				zcfgFeDalTR369LocalAgentMtp,				zcfgFeDalShowTR369LocalAgentMtp,				"get|add|edit|delete",	"TR369_LocalAgent"}, //TR369 Local Agent MTP
{"tr369_local_agent_mtp_mqtt",				TR369_LOCAL_AGENT_MTP_MQTT_param,			zcfgFeDalTR369LocalAgentMtpMqtt,			zcfgFeDalShowTR369LocalAgentMtpMqtt,			"get|edit",				"TR369_LocalAgent"}, //TR369 Local Agent MTP MQTT
{"tr369_local_agent_controller",			TR369_LOCAL_AGENT_CONTROLLER_param,			zcfgFeDalTR369LocalAgentController,			zcfgFeDalShowTR369LocalAgentController,			"get|add|edit|delete",	"TR369_LocalAgent"}, //TR369 Local Agent Controller
{"tr369_local_agent_controller_mtp",		TR369_LOCAL_AGENT_CONTROLLER_MTP_param,		zcfgFeDalTR369LocalAgentControllerMtp,		zcfgFeDalShowTR369LocalAgentControllerMtp,		"get|add|edit|delete",	"TR369_LocalAgent"}, //TR369 Local Agent Controller MTP
{"tr369_local_agent_controller_mtp_mqtt",	TR369_LOCAL_AGENT_CONTROLLER_MTP_MQTT_param,zcfgFeDalTR369LocalAgentControllerMtpMqtt,	zcfgFeDalShowTR369LocalAgentControllerMtpMqtt,	"get|add|edit|delete",	"TR369_LocalAgent"}, //TR369 Local Agent Controller MTP MQTT
#endif
#ifdef ZYXEL_L2TPV3
...
#endif
#ifdef TELIA_CUSTOMIZATION
{"sp_mgmt_srv", 	SP_MGMT_SRV_param,	zcfgFeDalSPMgmtSrv,		zcfgFeDalShowSPMgmtSrv,		"edit|get",			""},
#else
...
//#Support Online Firmware Upgrade for MTKSOC
#ifdef ZyXEL_Online_Firmware_Upgrade
{"online_fw_info",		ONLINE_FW_param,		zcfgFeDalOnlineFWInfo,		NULL,		"get",		"Firmware_Upgrade"},
#endif
//#Support Online Module Upgrade for MTKSOC
#ifdef ZyXEL_Online_Module_Upgrade
{"online_module_info",		ONLINE_Module_param,		zcfgFeDalOnlineModuleInfo,		NULL,		"get",		"Firmware_Upgrade"},
#endif
...
#ifdef CONFIG_MTKSOC_SCHEDULE_REBOOT_SUPPORT
{"schedule_reboot",    SCH_REBOOT_param, zcfgFeDalSchReboot,    zcfgFeDalShowSchReboot, "get|edit", "Reboot"},
#endif
#ifdef ZYXEL_CELLWAN_WITH_LTE_MODULE_TEMPERATURE
{"module_temperature",    CELLWAN_MODULE_TEMP_param, zcfgFeDalCellWanModuleTemp,    zcfgFeDalShowCellWanModuleTemp, "get", "Broadband"},
#endif
#ifdef ZYXEL_LWM2M_CLIENT
{"lwm2m",			LWM2M_param,			zcfgFeDalLWM2M,			zcfgFeDalShowLWM2M,			"get|edit|delete",			"Lwm2m_Client"},
#endif
...
/*
 *  Get Page data in RDM_OID_ZY_LOG_CFG_GP_ACCOUNT by zhttpd login user
 *  Use this page list data for authorization of dalHandler
*/
zcfgRet_t getPageDataByJobjUsername(struct json_object *Jobj, char *pageList) {

	// printf("(%s:%d) Enter\n", __func__, __LINE__);

	// zhttpd invoked insertLoginUserInfo() to add username and level into this Jobj
	const char *jobjUserName = json_object_get_string(json_object_object_get(Jobj, DAL_LOGIN_USERNAME));

	// printf("(%s:%d) jobjUserName(DAL_LOGIN_USERNAME) = %s\n", __func__, __LINE__, jobjUserName);
	...
	while ( zcfgFeObjJsonGetNextWithoutUpdate(RDM_OID_ZY_LOG_CFG_GP_ACCOUNT, &iid, &obj) == ZCFG_SUCCESS ) {
		...
		if ( !strcmp(userName, jobjUserName) ) {
			found = true;
...
#ifdef ZYXEL_DAL_AUTHORIZATION_BY_ACCOUNT_GROUP_PAGE_PRIVILEGE
/*
 * authorizeDalHandlerByPrivilege:
 * 		check if pageData contains dalHandlerPrivilege
 */
zcfgRet_t authorizeDalHandlerByPrivilege(char *dalHandlerPrivilege, char* pageData) {
	// printf("(%s:%d) dalHandlerPrivilege = %s\npageData:\n%s\n", __func__, __LINE__, dalHandlerPrivilege, pageData);

	// By pass privilege data is empty string.
	if (!strcmp(dalHandlerPrivilege, "")) {
		// printf("(%s:%d) privilege is an empty string, Bypass the authorization\n", __func__, __LINE__);
		return ZCFG_SUCCESS;
	}

	if (strstr(pageData, dalHandlerPrivilege) != NULL) {
		return ZCFG_SUCCESS;
	}

	printf("(%s:%d) privilege (%s) does not exist in page list\n", __func__, __LINE__, dalHandlerPrivilege);
	return ZCFG_NOT_FOUND;
}
/*
 * authorizeDalHandlerByAllowApiList:
 * 		check if allowApiList contains api_name
 */
zcfgRet_t authorizeDalHandlerByAllowApiList(char *api_name, char* allowApiList) {
	// printf("(%s:%d) api_name = %s\allowApiList:\n%s\n", __func__, __LINE__, api_name, allowApiList);

	if (strstr(allowApiList, api_name) != NULL) {
		return ZCFG_SUCCESS;
	}

	printf("(%s:%d) api_name (%s) does not exist in allow api list\n", __func__, __LINE__, api_name);
	return ZCFG_NOT_FOUND;
}
#endif
...
zcfgRet_t zcfgFeDalHandler(const char *handlerName, const char *method, struct json_object *Jobj, struct json_object *Jarray, char *replyMsg){
...
#ifdef ZYXEL_DAL_AUTHORIZATION_BY_ACCOUNT_GROUP_PAGE_PRIVILEGE
	// printf( "(%s:%d) dalHandler[%d].previlege = %s\n", __func__, __LINE__, i, dalHandler[i].previlege );
#if 1
	struct json_object *subJobj;
	const char* loginLevel;
	...
	if (json_object_get_type(Jobj) == json_type_object) {
		...
		loginLevel = json_object_get_string(json_object_object_get(subJobj, DAL_LOGIN_LEVEL));
	}

#endif
	// skip check dalHandler[i].previlege is ""
	// skip check level high
	// just authenticate medium and low level user
	if (  (loginLevel != NULL) && strcmp( "high", loginLevel ) ) {
#if 0
		// printf( "(%s:%d) [GUI API]: DAL_LOGIN_USERNAME = %s\n", __func__, __LINE__, json_object_get_string(json_object_object_get(Jobj, DAL_LOGIN_USERNAME)) );
		// printf( "(%s:%d) [GUI API]: DAL_LOGIN_LEVEL    = %s\n", __func__, __LINE__, loginLevel );
		// printf("(%s:%d) GUI account level is medium or low\n", __func__, __LINE__);

		if (getPageDataByJobjUsername(Jobj, pageList) != ZCFG_SUCCESS) {
			return ZCFG_INTERNAL_ERROR;
		}

		// printf( "(%s:%d) pageList:\n%s\n", __func__, __LINE__, pageList );

		// authorize the privilege of api(dalHandler)
		// Limit dalHandler by "previlege" property
		// (previlege in structure definition is a typo, it should be privilege)
		if ( authorizeDalHandlerByPrivilege(dalHandler[i].previlege, pageList) != ZCFG_SUCCESS ) {
			// printf("(%s:%d) Warning!! dal handler authorization failed\n", __func__, __LINE__);
			return ZCFG_REQUEST_REJECT;
		}
#endif
		char allowApiListMedium[2097] = "cardpage_status,lanhosts,login_privilege,mgmt_srv,wlan,lanhosts,status,cellwan_gnss,cellwan_status,wlan,wps,dh6r,static_dhcp,cellwan_mapn,cellwan_sim,cellwan,cellwan_band,wlan_sch_access,wifi_macfilter,wifi_others,lan,lanadv,static_route,nat,sp_mgmt_srv,nat_conf,nat_enable_conf,firewall,firewall_proto,firewall_acl,macfilter,paren_ctl,dev_sec_cert,logset,Traffic_Status,snmp,user_account,mgmt_srv,tr69,mgmt_srv_telnetonly,trust_domain,RDM_OID_DEV_SEC_CERT,RDM_OID_IP_IFACE,time,logset,PINGTEST";
		char allowApiListLow[2097] = "cardpage_status,lanhosts,login_privilege,mgmt_srv,wlan,lanhosts,status,cellwan_gnss,cellwan_status,wlan,wps,dh6r,static_dhcp,cellwan_mapn,cellwan_sim,cellwan,cellwan_band,wlan_sch_access,wifi_macfilter,wifi_others,lan,lanadv,static_route,nat,sp_mgmt_srv,nat_conf,nat_enable_conf,paren_ctl,logset,Traffic_Status,snmp,user_account,mgmt_srv,trust_domain,RDM_OID_DEV_SEC_CERT,RDM_OID_IP_IFACE,time,logset,PINGTEST";

		// authorize dalHandler.name with allow list
		if (strcmp( "medium", loginLevel ) == 0) {
			// medium account
			// printf("allowApiListMedium = %s\n", allowApiListMedium);
			if ( authorizeDalHandlerByAllowApiList(dalHandler[i].name, allowApiListMedium) != ZCFG_SUCCESS ) {
				// printf("(%s:%d) Warning!! dal handler authorization failed\n", __func__, __LINE__);
				return ZCFG_REQUEST_REJECT;
			}
		} else {
			// low account
			// printf("allowApiListMedium = %s\n", allowApiListLow);
			if ( authorizeDalHandlerByAllowApiList(dalHandler[i].name, allowApiListLow) != ZCFG_SUCCESS ) {
				// printf("(%s:%d) Warning!! dal handler authorization failed\n", __func__, __LINE__);
				return ZCFG_REQUEST_REJECT;
			}
		}
	...
	printf("(%s:%d) PASS dal handler authorization\n", __func__, __LINE__);
#endif

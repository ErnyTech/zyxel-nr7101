...
typedef struct rdm_DevInfo_s {   // RDM_OID_DEV_INFO 
	...
	uint32_t FirmwareImageNumberOfEntries;
	char BootFirmwareImage[65];
	char ActiveFirmwareImage[65];
...
typedef struct rdm_DevInfoFirmwareImage_s {   // RDM_OID_DEV_INFO_FIRMWARE_IMAGE 
	char Alias[65];
	char Name[65];
	char Version[65];
	bool Available;
	char Status[65];
	char BootFailureLog[257];
} rdm_DevInfoFirmwareImage_t;

typedef struct rdm_Download_s {   // RDM_OID_DOWNLOAD 
	char URL[2049];
	bool AutoActivate;
	char Username[257];
	char Password[257];
	uint32_t FileSize;
	char CheckSumAlgorithm[33];
	char CheckSum[256];
} rdm_Download_t;
...
typedef struct rdm_ConfigBackup_s {   // RDM_OID_CONFIG_BACKUP 
	char URL[2049];
	char Username[257];
	char Password[257];
} rdm_ConfigBackup_t;

typedef struct rdm_ConfigRestore_s {   // RDM_OID_CONFIG_RESTORE 
	char URL[2049];
	char Username[257];
	char Password[257];
	uint32_t FileSize;
	char TargetFileName[257];
	char CheckSumAlgorithm[65];
	char CheckSum[4097];
} rdm_ConfigRestore_t;
...
typedef struct rdm_DevInfoMemStat_s {   // RDM_OID_DEV_INFO_MEM_STAT 
	uint32_t Total;
	uint32_t Free;
	uint32_t X_ZYXEL_Active;
	uint32_t X_ZYXEL_Cached;
...
typedef struct rdm_DevInfoPsStatLoad_s {   // RDM_OID_DEV_INFO_PS_STAT_LOAD 
	char Load_1m[17];
	char Load_5m[17];
	char Load_15m[17];
	...
	uint32_t Total_Proc;
	uint32_t High_Id;
} rdm_DevInfoPsStatLoad_t;

typedef struct rdm_DevInfoPsStatCpu_s {   // RDM_OID_DEV_INFO_PS_STAT_CPU 
	uint32_t User;
	uint32_t Nice;
	uint32_t System;
	uint32_t Idle;
...
typedef struct rdm_LogUpload_s {   // RDM_OID_LOG_UPLOAD 
	char URL[2049];
	char Username[257];
	char Password[257];
} rdm_LogUpload_t;
...
typedef struct rdm_Bt_s {   // RDM_OID_BT 
	uint32_t X_ZYXEL_InterfaceNumberOfEntries;
	uint32_t X_ZYXEL_PortNumberOfEntries;
} rdm_Bt_t;

typedef struct rdm_BtIntf_s {   // RDM_OID_BT_INTF 
	bool Enable;
	char Status[17];
	char Name[11];
	char DeviceName[21];
...
typedef struct rdm_CellIntf_s {   // RDM_OID_CELL_INTF 
	...
	char SupportedServiceDomain[129];
	char PreferredServiceDomain[17];
	...
	uint32_t X_ZYXEL_CurrentBandNum;
	int X_ZYXEL_CellID;
	int X_ZYXEL_SiteID;
	...
	int X_ZYXEL_RI;
	int X_ZYXEL_PMI;
	int X_ZYXEL_NR5G_PUSCH_MCS;
	int X_ZYXEL_NR5G_PUSCH_MOD_TYPE;
	uint32_t X_ZYXEL_NR5G_PUSCH_RB_START;
	uint32_t X_ZYXEL_NR5G_PUSCH_RB_NUM;
	uint32_t X_ZYXEL_NR5G_PUSCH_TB_SIZE;
	int X_ZYXEL_TEMPERATURE_CPU0;
	int X_ZYXEL_TEMPERATURE_SDX;
	int X_ZYXEL_TEMPERATURE_AMBIENT;
	bool X_ZYXEL_HW_NAT_Enable;
	char X_ZYXEL_ModuleSoftwareVersion[129];
	char X_ZYXEL_ModuleSoftwareSubVersion[129];
	bool X_ZYXEL_CDRX_Enable;
} rdm_CellIntf_t;
...
typedef struct rdm_CellIntfUsim_s {   // RDM_OID_CELL_INTF_USIM 
	...
	bool X_ZYXEL_Detach_Switch;
	uint8_t X_ZYXEL_Slot;
	uint8_t X_ZYXEL_CURRENT_SLOT;
...
typedef struct rdm_CellIntfZyQscan_s {   // RDM_OID_CELL_INTF_ZY_QSCAN 
	bool Enable;
	bool BootScan;
	uint32_t NumberOfQscanList;
} rdm_CellIntfZyQscan_t;

typedef struct rdm_CellIntfZyQscanList_s {   // RDM_OID_CELL_INTF_ZY_QSCAN_LIST 
	int PhyCellID;
	uint32_t RFCN;
	char ACT[33];
	uint32_t MCC;
	...
	int RSRP;
	int RSRQ;
} rdm_CellIntfZyQscanList_t;

typedef struct rdm_CellIntfZyPciLockNr_s {   // RDM_OID_CELL_INTF_ZY_PCI_LOCK_NR 
	bool Enable;
	uint32_t RFCN;
	uint32_t Band;
	int PhyCellID;
...
typedef struct rdm_CellZyNbr_s {   // RDM_OID_CELL_ZY_NBR 
	bool Enable;
} rdm_CellZyNbr_t;
...
typedef struct rdm_IpDiagDlDiag_s {   // RDM_OID_IP_DIAG_DL_DIAG 
	...
	uint32_t TestBytesReceivedUnderFullLoading;
	uint32_t TotalBytesReceivedUnderFullLoading;
	uint32_t TotalBytesSentUnderFullLoading;
...
typedef struct rdm_PerConnectionResult_s {   // RDM_OID_PER_CONNECTION_RESULT 
	char ROMTime[32];
	char BOMTime[32];
	char EOMTime[32];
	uint32_t TestBytesReceived;
	...
	char TCPOpenRequestTime[32];
	char TCPOpenResponseTime[32];
} rdm_PerConnectionResult_t;

typedef struct rdm_IncrementalResult_s {   // RDM_OID_INCREMENTAL_RESULT 
	uint32_t TestBytesReceived;
	uint32_t TotalBytesReceived;
	uint32_t TotalBytesSent;
	char StartTime[32];
	char EndTime[32];
} rdm_IncrementalResult_t;
...
typedef struct rdm_IpDiagIpLayerModal_s {   // RDM_OID_IP_DIAG_IP_LAYER_MODAL 
	char MaxIPLayerCapacity[97];
	char TimeOfMax[32];
	char MaxETHCapacityNoFCS[97];
	char MaxETHCapacityWithFCS[97];
	...
	char ReplicatedRatioAtMax[97];
	char InterfaceEthMbpsAtMax[97];
} rdm_IpDiagIpLayerModal_t;

typedef struct rdm_IpDiagIpLayerIncreRes_s {   // RDM_OID_IP_DIAG_IP_LAYER_INCRE_RES 
	char IPLayerCapacity[97];
	char TimeOfSubInterval[32];
	char LossRatio[97];
	char RTTRange[97];
	char PDVRange[97];
	char MinOnewayDelay[97];
	char ReorderedRatio[97];
	char ReplicatedRatio[97];
	char InterfaceEthMbps[97];
} rdm_IpDiagIpLayerIncreRes_t;
...
typedef struct rdm_IPConnTrack_s {   // RDM_OID_I_P_CONN_TRACK 
	uint32_t UDP;
	uint32_t TCP;
	uint32_t Other;
} rdm_IPConnTrack_t;
...
typedef struct rdm_IpsecIkev2sa_s {   // RDM_OID_IPSEC_IKEV2SA 
	...
	uint32_t ChildSANumberOfEntries;
} rdm_IpsecIkev2sa_t;
...
typedef struct rdm_GreTunnel_s {   // RDM_OID_GRE_TUNNEL 
	...
	uint32_t X_ZYXEL_VlanGroupNumberOfEntries;
...
typedef struct rdm_HostsHost_s {   // RDM_OID_HOSTS_HOST 
	char Alias[65];
	char PhysAddress[65];
	char X_ZYXEL_PhysAddressOUI[17];
	char IPAddress[49];
	char IPAddress6[49];
...
typedef struct rdm_Dhcpv4SrvCusDhcpOpt_s {   // RDM_OID_DHCPV4_SRV_CUS_DHCP_OPT 
	char SrvName[257];
	char OptId[257];
	char OptContext[257];
} rdm_Dhcpv4SrvCusDhcpOpt_t;
...
typedef struct rdm_InstallDU_s {   // RDM_OID_INSTALL_D_U 
	char URL[2049];
	char UUID[37];
	char Username[257];
	char Password[257];
	char ExecutionEnvRef[257];
} rdm_InstallDU_t;

typedef struct rdm_SWModDUStateChange_s {   // RDM_OID_S_W_MOD_D_U_STATE_CHANGE 
	char UUID[37];
	char DeploymentUnitRef[257];
	char Version[33];
	char CurrentState[17];
	bool Resolved;
	char ExecutionUnitRefList[257];
	char StartTime[32];
	char CompleteTime[32];
	char OperationPerformed[17];
} rdm_SWModDUStateChange_t;
...
typedef struct rdm_SWModUpdate_s {   // RDM_OID_S_W_MOD_UPDATE 
	char URL[2049];
	char Username[257];
	char Password[257];
} rdm_SWModUpdate_t;

typedef struct rdm_SWModUninstall_s {   // RDM_OID_S_W_MOD_UNINSTALL 
} rdm_SWModUninstall_t;
...
typedef struct rdm_SWModEUSetRequestedState_s {   // RDM_OID_S_W_MOD_E_U_SET_REQUESTED_STATE 
	char RequestedState[9];
} rdm_SWModEUSetRequestedState_t;
...
typedef struct rdm_BulkDataProf_s {   // RDM_OID_BULK_DATA_PROF 
	...
	char Alias[65];
	char Name[256];
	char Controller[1025];
	int NumberOfRetainedFailedReports;
	char Protocol[14];
	char EncodingType[6];
...
typedef struct rdm_CSVEncoding_s {   // RDM_OID_C_S_V_ENCODING 
	char FieldSeparator[65];
	char RowSeparator[65];
	char EscapeCharacter[65];
	char ReportFormat[65];
	char RowTimestamp[65];
} rdm_CSVEncoding_t;

typedef struct rdm_JSONEncoding_s {   // RDM_OID_J_S_O_N_ENCODING 
	char ReportFormat[65];
	char ReportTimestamp[65];
} rdm_JSONEncoding_t;

typedef struct rdm_BulkDataProfileHTTP_s {   // RDM_OID_BULK_DATA_PROFILE_H_T_T_P 
	char URL[2049];
	char Username[257];
	char Password[257];
	char CompressionsSupported[65];
	char Compression[65];
	char MethodsSupported[33];
	char Method[33];
	bool UseDateHeader;
	bool RetryEnable;
	uint32_t RetryMinimumWaitInterval;
	uint32_t RetryIntervalMultiplier;
	uint32_t RequestURIParameterNumberOfEntries;
	bool PersistAcrossReboot;
} rdm_BulkDataProfileHTTP_t;

typedef struct rdm_BulkDataProfParamPush_s {   // RDM_OID_BULK_DATA_PROF_PARAM_PUSH 
	char Data[65536];
} rdm_BulkDataProfParamPush_t;
...
typedef struct rdm_DevInfoLocalAgentTransferComplete_s {   // RDM_OID_DEV_INFO_LOCAL_AGENT_TRANSFER_COMPLETE 
	char Command[257];
	char CommandKey[257];
	char Requestor[257];
	char TransferType[257];
	char Affected[257];
	char TransferURL[2049];
	char StartTime[32];
	char CompleteTime[32];
	uint32_t FaultCode;
	char FaultString[257];
} rdm_DevInfoLocalAgentTransferComplete_t;

typedef struct rdm_DevLocalAgentSubTopicList_s {   // RDM_OID_DEV_LOCAL_AGENT_SUB_TOPIC_LIST 
	bool Enable;
	char ID[65];
	char Topic[65536];
} rdm_DevLocalAgentSubTopicList_t;
...
typedef struct rdm_DevLocalAgentMTPCoAP_s {   // RDM_OID_DEV_LOCAL_AGENT_M_T_P_CO_A_P 
	char Interfaces[257];
	uint32_t Port;
	char Path[257];
	bool IsEncrypted;
	bool EnableEncryption;
} rdm_DevLocalAgentMTPCoAP_t;

typedef struct rdm_DevLocalAgentMTPSTOMP_s {   // RDM_OID_DEV_LOCAL_AGENT_M_T_P_S_T_O_M_P 
	char Reference[257];
	char Destination[257];
	char DestinationFromServer[257];
} rdm_DevLocalAgentMTPSTOMP_t;

typedef struct rdm_DevLocalAgentMTPWebSocket_s {   // RDM_OID_DEV_LOCAL_AGENT_M_T_P_WEB_SOCKET 
	char Interfaces[257];
	uint32_t Port;
	char Path[257];
	bool EnableEncryption;
} rdm_DevLocalAgentMTPWebSocket_t;
...
typedef struct rdm_DevLocalAgentSubscription_s {   // RDM_OID_DEV_LOCAL_AGENT_SUBSCRIPTION 
	char Alias[65];
	bool Enable;
	char Recipient[257];
	char ID[65];
	char CreationDate[32];
	char NotifType[258];
	char ReferenceList[258];
	bool Persistent;
	uint32_t TimeToLive;
	bool NotifRetry;
	uint32_t NotifExpiration;
} rdm_DevLocalAgentSubscription_t;

typedef struct rdm_DevLocalAgentRequest_s {   // RDM_OID_DEV_LOCAL_AGENT_REQUEST 
	char Alias[65];
	char Originator[257];
	char Command[257];
	char CommandKey[257];
	char Status[33];
} rdm_DevLocalAgentRequest_t;

typedef struct rdm_Cancel_s {   // RDM_OID_CANCEL 
} rdm_Cancel_t;

typedef struct rdm_DevLocalAgentCertificate_s {   // RDM_OID_DEV_LOCAL_AGENT_CERTIFICATE 
	char Alias[65];
	bool Enable;
	char SerialNumber[65];
	char Issuer[257];
	char X_ZYXEL_SecurityCert[257];
} rdm_DevLocalAgentCertificate_t;

typedef struct rdm_Delete_s {   // RDM_OID_DELETE 
} rdm_Delete_t;

typedef struct rdm_DevLocalAgentCertRoleMappingList_s {   // RDM_OID_DEV_LOCAL_AGENT_CERT_ROLE_MAPPING_LIST 
	char Alias[65];
	char Hash[65];
	char Role[257];
} rdm_DevLocalAgentCertRoleMappingList_t;

typedef struct rdm_DevLocalAgentControllerTrust_s {   // RDM_OID_DEV_LOCAL_AGENT_CONTROLLER_TRUST 
	char UntrustedRole[257];
	char BannedRole[257];
	bool TOFUAllowed;
	uint32_t TOFUInactivityTimer;
	uint32_t RoleNumberOfEntries;
	uint32_t CredentialNumberOfEntries;
	uint32_t ChallengeNumberOfEntries;
} rdm_DevLocalAgentControllerTrust_t;

typedef struct rdm_LocalAgentControllerTrustReqChallenge_s {   // RDM_OID_LOCAL_AGENT_CONTROLLER_TRUST_REQ_CHALLENGE 
	char ChallengeRef[257];
	int RequestExpiration;
	char Instruction[65];
	char InstructionType[257];
	char ValueType[257];
	char ChallengeID[257];
} rdm_LocalAgentControllerTrustReqChallenge_t;

typedef struct rdm_LocalAgentControllerTrustChallengeResp_s {   // RDM_OID_LOCAL_AGENT_CONTROLLER_TRUST_CHALLENGE_RESP 
	char ChallengeID[257];
	char Value[65];
} rdm_LocalAgentControllerTrustChallengeResp_t;

typedef struct rdm_LocalAgentControllerTrustRole_s {   // RDM_OID_LOCAL_AGENT_CONTROLLER_TRUST_ROLE 
	char Alias[65];
	bool Enable;
	char Name[257];
	uint32_t PermissionNumberOfEntries;
} rdm_LocalAgentControllerTrustRole_t;

typedef struct rdm_LocalAgentControllerTrustRolePermission_s {   // RDM_OID_LOCAL_AGENT_CONTROLLER_TRUST_ROLE_PERMISSION 
	char Alias[65];
	bool Enable;
	uint32_t Order;
	char Targets[257];
	char Param[5];
	char Obj[5];
	char InstantiatedObj[5];
	char CommandEvent[5];
} rdm_LocalAgentControllerTrustRolePermission_t;

typedef struct rdm_LocalAgentControllerTrustCredential_s {   // RDM_OID_LOCAL_AGENT_CONTROLLER_TRUST_CREDENTIAL 
	char Alias[65];
	bool Enable;
	char Role[257];
	char Credential[257];
	char AllowedUses[257];
} rdm_LocalAgentControllerTrustCredential_t;

typedef struct rdm_LocalAgentControllerTrustChallenge_s {   // RDM_OID_LOCAL_AGENT_CONTROLLER_TRUST_CHALLENGE 
	char Alias[65];
	char Description[257];
	char Role[257];
	bool Enable;
	...
	char ValueType[257];
	char Instruction[65];
	char InstructionType[65];
	uint32_t Retries;
	int LockoutPeriod;
} rdm_LocalAgentControllerTrustChallenge_t;
...
typedef struct rdm_DevLocalAgentController_s {   // RDM_OID_DEV_LOCAL_AGENT_CONTROLLER 
	...
	uint32_t X_ZYXEL_Notify;
	uint32_t BootParameterNumberOfEntries;
	uint32_t MTPNumberOfEntries;
} rdm_DevLocalAgentController_t;

typedef struct rdm_LocalAgentControllerScheduleTimer_s {   // RDM_OID_LOCAL_AGENT_CONTROLLER_SCHEDULE_TIMER 
	uint32_t DelaySeconds;
} rdm_LocalAgentControllerScheduleTimer_t;

typedef struct rdm_LocalAgentControllerTimer_s {   // RDM_OID_LOCAL_AGENT_CONTROLLER_TIMER 
	char CommandKey[257];
} rdm_LocalAgentControllerTimer_t;

typedef struct rdm_LocalAgentControllerAddMyCertificate_s {   // RDM_OID_LOCAL_AGENT_CONTROLLER_ADD_MY_CERTIFICATE 
	char Alias[65];
	char Certificate[65536];
} rdm_LocalAgentControllerAddMyCertificate_t;

typedef struct rdm_LocalAgentControllerSendOnBoardRequest_s {   // RDM_OID_LOCAL_AGENT_CONTROLLER_SEND_ON_BOARD_REQUEST 
} rdm_LocalAgentControllerSendOnBoardRequest_t;
...
typedef struct rdm_LocalAgentControllerMTPCoAP_s {   // RDM_OID_LOCAL_AGENT_CONTROLLER_M_T_P_CO_A_P 
	char Host[257];
	uint32_t Port;
	char Path[257];
	bool EnableEncryption;
} rdm_LocalAgentControllerMTPCoAP_t;

typedef struct rdm_LocalAgentControllerMTPSTOMP_s {   // RDM_OID_LOCAL_AGENT_CONTROLLER_M_T_P_S_T_O_M_P 
	char Reference[257];
	char Destination[257];
} rdm_LocalAgentControllerMTPSTOMP_t;

typedef struct rdm_LocalAgentControllerMTPWebSocket_s {   // RDM_OID_LOCAL_AGENT_CONTROLLER_M_T_P_WEB_SOCKET 
	char Host[257];
	uint32_t Port;
	char Path[257];
	char IsEncrypted[257];
	bool EnableEncryption;
	uint32_t KeepAliveInterval;
	uint32_t CurrentRetryCount;
	uint32_t SessionRetryMinimumWaitInterval;
	uint32_t SessionRetryIntervalMultiplier;
} rdm_LocalAgentControllerMTPWebSocket_t;

typedef struct rdm_LocalAgentControllerMTPWebSocketReset_s {   // RDM_OID_LOCAL_AGENT_CONTROLLER_M_T_P_WEB_SOCKET_RESET 
} rdm_LocalAgentControllerMTPWebSocketReset_t;
...
typedef struct rdm_LocalAgentControllerTransferCompletePolicy_s {   // RDM_OID_LOCAL_AGENT_CONTROLLER_TRANSFER_COMPLETE_POLICY 
	char ResultTypeFilter[257];
} rdm_LocalAgentControllerTransferCompletePolicy_t;

typedef struct rdm_LocalAgentControllerBootParameter_s {   // RDM_OID_LOCAL_AGENT_CONTROLLER_BOOT_PARAMETER 
	char Alias[65];
	bool Enable;
	char ParameterName[257];
} rdm_LocalAgentControllerBootParameter_t;

typedef struct rdm_LocalAgentControllerE2ESession_s {   // RDM_OID_LOCAL_AGENT_CONTROLLER_E2_E_SESSION 
	bool Enable;
	char Status[257];
	uint32_t SessionExpiration;
	uint32_t SessionRetryMinimumWaitInterval;
	uint32_t SessionRetryIntervalMultiplier;
	uint32_t CurrentRetryCount;
	uint32_t SegmentedPayloadChunkSize;
	int MaxRetransmitTries;
	char PayloadSecurity[257];
} rdm_LocalAgentControllerE2ESession_t;

typedef struct rdm_LocalAgentControllerE2ESessionReset_s {   // RDM_OID_LOCAL_AGENT_CONTROLLER_E2_E_SESSION_RESET 
} rdm_LocalAgentControllerE2ESessionReset_t;

typedef struct rdm_AddCertificate_s {   // RDM_OID_ADD_CERTIFICATE 
	char Alias[65];
	char Certificate[65536];
} rdm_AddCertificate_t;
...
typedef struct rdm_MqttClient_s {   // RDM_OID_MQTT_CLIENT 
	...
	uint32_t BrokerPort;
	char BindAddress[257];
	char BindInterfaceName[257];
...
typedef struct rdm_Xmpp_s {   // RDM_OID_XMPP 
	...
	char SupportedServerConnectAlgorithms[65];
} rdm_Xmpp_t;
...
typedef struct rdm_XmppConn_s {   // RDM_OID_XMPP_CONN 
	...
	uint32_t ServerConnectAttempts;
	uint32_t ServerRetryInitialInterval;
	uint32_t ServerRetryIntervalMultiplier;
	uint32_t ServerRetryMaxInterval;
	bool UseTLS;
	bool TLSEstablished;
	uint32_t ServerNumberOfEntries;
} rdm_XmppConn_t;

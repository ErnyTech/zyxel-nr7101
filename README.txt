ReadMe for NR7101_Generic(V1.00(ABUV.8)C0)


0. Introduction

  This file will show you how to build the NR7101_Generic linux system,
...
1. Files list
   ...
   B.  V100ABUV8C0_GPL.tar.bz2	- Open Source Code of NR7101_Generic and Open Source Code of Toolchain
...
6. The image is in the images directory.
    ...
    You can use it update NR7101_Generic by using the firmware update procedure.
